...
public class Cattle implements Serializable {
    ...
    // Identity by primary key so JSF selectOneMenu can match a converted value
    // against the items in the dropdown list.
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Cattle other)) return false;
